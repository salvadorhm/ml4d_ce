...
class Rename:
    ...
    def GET(self, column):
        try:
            ...
            return render.rename(column,nulls,dtypes,unique,mode,mean,median)
    ...
    def POST(self, column):
        try:
            ...
            code_lines = []
            code_lines.append("# Renombar la columna '"+column+"'")
            code_lines.append("dataframe.rename(columns={'"+column+"':'"+new_name+"'}, inplace=True)")
